...
# Multi-Face Recognition System v2.1
# Enhanced version with multiple face detection and comparison
...
<div style="text-align: center; margin: 20px; padding: 20px; background-color: white; border-radius: 5px;">
    ...
    <tt style="display: block; margin-top: 20px; color: #666;">Enhanced Multi-Face by Visi@n - Interactive Face Recognition System v2.1</tt>
</div>
</body>
</html>'''
...
frame = tk.Frame(root)
frame.pack()
root.wm_title("Multi-Face Recognition v2.1")
...
info_label = tk.Label(header_frame,
                     text="Advanced facial detection and comparison with landmarks analysis",
                     fg="#ecf0f1",
                     bg="#2c3e50",
...
footer_label = tk.Label(footer_frame,
                       text="Enhanced Multi-Face Recognition System v2.1 • Developed by Visi@n • https://tsurugi-linux.org",
                       fg="#ecf0f1",
                       bg="#34495e",
