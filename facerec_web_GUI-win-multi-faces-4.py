...
label.pack(ipadx=5, ipady=4, pady=10, padx=10)
...
info_label.place(x=160, y=40)

# Separatore
separator1 = tk.Label(text="━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                      fg="gray",
                      font=("helvetica", 8))
separator1.place(x=10, y=75)
...
dir_info_label = tk.Label(text="📁 Working Directories:",
                         fg="darkgreen",
                         font=("helvetica", 10, "bold"))
dir_info_label.place(x=10, y=90)

known_label = tk.Label(text=f"Known Sources:",
                      fg="black",
                      font=("helvetica", 8, "bold"))
known_label.place(x=10, y=115)

known_path_label = tk.Label(text=known_dir,
                           fg="darkblue",
                           font=("courier", 7),
                           anchor="w",
                           justify="left")
known_path_label.place(x=10, y=130)

unknown_label = tk.Label(text=f"Unknown Targets:",
                        fg="black",
                        font=("helvetica", 8, "bold"))
unknown_label.place(x=10, y=150)

unknown_path_label = tk.Label(text=unknown_dir,
                             fg="darkblue",
                             font=("courier", 7),
                             anchor="w",
                             justify="left")
unknown_path_label.place(x=10, y=165)

# Separatore
separator2 = tk.Label(text="━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
                      fg="gray",
                      font=("helvetica", 8))
separator2.place(x=10, y=185)

# Frame per i bottoni
button_frame = tk.Frame(root)
button_frame.pack(pady=210)
...
button = tk.Button(button_frame,
                   ...
                   font=("helvetica", 10, "bold"),
                   command=quit)
button.pack(ipadx=160, ipady=4, pady=8)

slogan = tk.Button(button_frame,
                   text="🗂️  OPEN WORK DIRECTORY",
                   fg="#ffffff",
                   bg="#550000",
                   font=("helvetica", 9, "bold"),
                   command=openWorkingDirectory)
slogan.pack(ipadx=85, ipady=4, pady=3)
...
slogan = tk.Button(button_frame,
                   ...
                   font=("helvetica", 9),
                   command=compare01)
slogan.pack(ipadx=70, ipady=4, pady=3)
...
slogan = tk.Button(button_frame,
                   ...
                   font=("helvetica", 9),
                   command=compare40)
slogan.pack(ipadx=66, ipady=4, pady=3)
...
# Footer
footer_label = tk.Label(text="Enhanced Multi-Face Recognition v2.1 by Visi@n",
                       fg="red",
                       font=("helvetica", 9, "italic"))
footer_label.place(x=100, y=555)
