...
<style>
    ...
    .match-container { background-color: white; margin: 10px; padding: 15px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
    .image-pair { display: flex; align-items: center; gap: 20px; }
    ...
    .match-info { background-color: #e8f5e8; padding: 10px; border-radius: 5px; min-width: 200px; }
